tourMapper.controller('ShowsCtrl', function($scope, $http, $filter, showFactory, $cookieStore) {
	...
	$scope.map = function() {
		L.mapbox.accessToken = 'pk.eyJ1IjoibWlja2V5c2FuY2hleiIsImEiOiJjaXU2NHl5ZnIwajliMnVxdG9semp1Y2psIn0.C23fYL2agh5b4TqwHIpWng';
		var map = L.mapbox.map('map', 'mapbox.streets').setView([30, 10], 1);
