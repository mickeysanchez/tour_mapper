...
// '&lt;meta name='viewport' content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no' /&gt; &lt;script src='https://api.tiles.mapbox.com/mapbox.js/v1.6.1/mapbox.js'&gt;&lt;/script&gt; &lt;link href='https://api.tiles.mapbox.com/mapbox.js/v1.6.1/mapbox.css' rel='stylesheet' /&gt; &lt;style&gt; #map { border: 1px solid black; width: 900px; height: 500px; } &lt;/style&gt; &lt;div id='map'&gt;&lt;/div&gt; &lt;script&gt; var map = L.mapbox.map('map', 'examples.map-9ijuk24y').setView([30, 10], 2); map.scrollWheelZoom.disable(); var featureLayer = L.mapbox.featureLayer().setGeoJSON([{"ticket_url":"http://seatgeek.com/beyonce-with-monsieur-adi-tickets/amsterdam-ziggo-dome-2014-03-18-8-pm/concert/1925224/","datetime_local":"2014-03-19T00:00:00.000Z","venue":{"name":"Ziggo Dome","display_location":"Amsterdam, Netherlands"},"type":"Feature","geometry":{"type":"Point","coordinates":[4.9377,52.3171]},"properties":{"title":"Mar 18, 2014","description":"&lt;a href='http://seatgeek.com/beyonce-with-monsieur-adi-tickets/amsterdam-ziggo-dome-2014-03-18-8-pm/concert/1925224/'&gt; Tickets &lt;/a&gt;","marker-size":"small","marker-color":"#070"}}]); map.fitBounds(featureLayer.getBounds()); featureLayer.addTo(map); &lt;/script&gt;'
// 
// '&lt;meta name='viewport' content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no' /&gt; &lt;script src='https://api.tiles.mapbox.com/mapbox.js/v1.6.1/mapbox.js'&gt;&lt;/script&gt; &lt;link href='https://api.tiles.mapbox.com/mapbox.js/v1.6.1/mapbox.css' rel='stylesheet' /&gt; &lt;style&gt; #map { border: 1px solid black; width: 900px; height: 500px; } &lt;/style&gt; &lt;div id='map'&gt;&lt;/div&gt; &lt;script&gt; var map = L.mapbox.map('map', 'examples.map-9ijuk24y').setView([30, 10], 2); map.scrollWheelZoom.disable(); var featureLayer = L.mapbox.featureLayer().setGeoJSON([{"ticket_url":"http://seatgeek.com/beyonce-with-monsieur-adi-tickets/amsterdam-ziggo-dome-2014-03-18-8-pm/concert/1925224/","datetime_local":"2014-03-19T00:00:00.000Z","venue":{"name":"Ziggo Dome","display_location":"Amsterdam, Netherlands"},"type":"Feature","geometry":{"type":"Point","coordinates":[4.9377,52.3171]},"properties":{"title":"Mar 18, 2014","description":"<a href='http://seatgeek.com/beyonce-with-monsieur-adi-tickets/amsterdam-ziggo-dome-2014-03-18-8-pm/concert/1925224/'> Tickets </a>","marker-size":"small","marker-color":"#070"}}]); map.fitBounds(featureLayer.getBounds()); featureLayer.addTo(map); &lt;/script&gt;'